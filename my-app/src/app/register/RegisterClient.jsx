...
export default function RegisterPage() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setError(
                err.response?.data?.message || "user already registered failed. Try again."
            )
        ...
        <div className="min-h-screen flex ">
            ...
            <div className="w-full border lg:w-2/5 flex flex-col justify-center px-8 md:px-16 lg:px-24">
                <div className="max-w-md w-full mx-auto">
                    ...
                    <p className="text-muted-foreground mb-8">Join us today and start building your journey with us.</p>
